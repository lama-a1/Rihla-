...
const dict = {
  en: {
    ...
    whatDidYouLikeMost: "What did you like most?",
    whatDidntWorkForYou: "What didn't work for you?",
    tellUsMore: "Tell us more about your experience",
    greatForPhotography: "Great for photography",
    quietAndRelaxing: "Quiet and relaxing",
    submitRating: "Submit rating",
    alreadyRatedThisPlace: "You already rated this place — ask for another one.",
  ...
  loved: "أعجبني المكان",
    okay: "كانت التجربة مقبولة",
    tooCrowded: "مزدحم جدًا",
    tooHot: "الجو حار",
    tooTired: "شعرت بالتعب",
    tooMuchWalking: "يتطلب مشيًا كثيرًا",
    tooExpensive: "التكلفة مرتفعة",
    rateYourExperience: "قيّم تجربتك",
    howWasYourExperience: "كيف كانت تجربتك؟",
    whatDidYouLikeMost: "ما أكثر ما أعجبك في تجربتك؟",
    whatDidntWorkForYou: "ما الذي لم يناسبك في تجربتك؟",
    tellUsMore: "أخبرنا المزيد عن تجربتك",
    greatForPhotography: "ممتاز للتصوير",
    quietAndRelaxing: "هادئ ومريح",
    submitRating: "تأكيد التقييم",
    alreadyRatedThisPlace: "قيّمت هذا المكان من قبل — يمكنك طلب مكان آخر.",
